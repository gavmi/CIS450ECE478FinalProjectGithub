...
esp_err_t audio_handle_info(PDM_SOUND_TYPE voice)
{
    ...
    case SOUND_TYPE_FACTORY:
        ...
        break;
    //my stuff--------------------------------------------------------------------------------
    //all of these are added audio cases for our custom audio files
    case SOUND_TYPE_0:
        sprintf(filepath, "%s/%s", CONFIG_BSP_SPIFFS_MOUNT_POINT, "Light_level_0.mp3");
        break;
    case SOUND_TYPE_25:
        sprintf(filepath, "%s/%s", CONFIG_BSP_SPIFFS_MOUNT_POINT, "Light_level_25.mp3");
        break;
    case SOUND_TYPE_50:
        sprintf(filepath, "%s/%s", CONFIG_BSP_SPIFFS_MOUNT_POINT, "Light_level_50.mp3");
        break;
    case SOUND_TYPE_75:
        sprintf(filepath, "%s/%s", CONFIG_BSP_SPIFFS_MOUNT_POINT, "Light_level_75.mp3");
        break;
    case SOUND_TYPE_100:
        sprintf(filepath, "%s/%s", CONFIG_BSP_SPIFFS_MOUNT_POINT, "Light_level_100.mp3");
        break;
    //my stuff--------------------------------------------------------------------------------
    }
